...
%*Last Modified: jue 05 abr 2018 00:16:44 PDT
...
plot3(x,y,z,'o');zlim([0,1]);
hold on;
plot3(x_full,yhat,0*yhat);
plot3(x_star,sin(x_star),0,'*');
m=max(prob_density(z2))*1.2;
plot3(0*z2+x_star,z2,prob_density(z2)/m);
grid on
%set(gca,'xtick',[]);
set(gca,'xticklabel',[]);
%set(gca,'ytick',[]);
