...
under study we can find the paramters that best suits the model. \textbf{Talk about
how to find the paramters of the model}
...
\textbf{Here talk a little bit about what kind of criteria can you use to assess the goodness of the design}
\newpage
