...
We perform a sensitivity analysis on the map $\phi$ 
...
The results obtained are shown in the box plots in Figure \ref{figSensitivityPlot}.


\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{./FigChap4/sensitivityPlot}
